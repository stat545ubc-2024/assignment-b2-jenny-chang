...
The goal of countunique is to provide a function that can calculate the number of unique values in a specified column when grouping by one or more variables.
